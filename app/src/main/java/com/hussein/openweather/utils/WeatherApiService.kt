...
object WeatherApiService {
    ...
    suspend fun getWeather(): Result<WeatherApiResponse> {
        return runCatching {
            val result = client.get(urlString = "https://api.openweathermap.org/data/2.5/weather?lat=31.1866&lon=32.0322&appid=6baba60ac76ba1ef52815e6b3ca1fe1c&units=metric")
